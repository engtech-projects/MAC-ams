        ...
        <div class="card">
                ...
                <div class="col-md-12 text-right">
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu dropdown-menu-right" role="menu" style="left:0;">
                       ...
                       <!--  <a class="dropdown-item" data-title="Payment" data-remote="" href="#">Payment</a> -->
                      </div>
                    </div>
                  </div>
              </div>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label for="" class="label-normal">Customer </label>
                  <select class="form-control form-control-sm rounded-0" id="flt-customer">
              ...
              <div class="col-md-2">
                 <div class="form-group">
                  ...
                  <div class="input-group">
                    <button type="button" class="btn btn-sm btn-success btn-apply-filters" data-type="sales">
                      Apply Filters
                    </button>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <table class="table table-bordered table-sm table-hover" id="tbl-sales-list">
                  <thead>
                    <tr>
