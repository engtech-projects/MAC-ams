...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="col-md-12 text-right">
                                <a id="printCharOfAccountExcel" type="chart_of_account"
                                    class="btn btn-flat btn-sm bg-gradient-success">Print excel</a>
                            </div>
                        ...
                        <div class="card-body" style="background:#f5f5f5;">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-2 col-xs-2 col-sm-2 text-center bordered-box-header">Account
                                            Number</div>
                                        <div class="col-md-6 col-xs-6 col-sm-6 text-center bordered-box-header">Account Name
                                        </div>
                                        <div class="col-md-3 col-xs-3 col-sm-3 text-center bordered-box-header">Bank
                                            Reconcillation </div>
                                    ...
                                    @foreach ($organizedAccount as $key => $accounts)
                                        <div class="row">
                                            <div class="col-md-12 text-left "
                                                style="font-size:15px; font-weight:bold; border-bottom:1px dashed black; border-top:1px dashed black;">
                                                {{ strtoupper($key) }}</div>
                                        </div>
                                        @foreach ($accounts['content'] as $account)
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-xs-3 col-sm-3 text-cgenter">
                                            ...
                                            @foreach ($account['child'] as $child)
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-xs-4 col-sm-4 text- ">
    ...
    <div class="modal fade" :class="{ show: showModal }"
        :style="{ display: showModal ? 'block' : 'none', backgroundColor: 'rgba(0,0,0,0.5)' }" tabindex="-1"
        role="dialog">
        <div class="modal-dialog" role="document" @click.self="closeModal">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Vue-Only Modal</h5>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm rounded-0" id="class_name"
