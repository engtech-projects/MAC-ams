                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select v-model="filter.account_id" name="account_id"
                                                ...
                                                value="{{ request('account_id') }}" required>
                                                <option value="all" selected>-All-</option>
                                                <option v-for="acc,a in filteredAccounts" :key="a"
                                                    :value="acc.account_id">@{{ acc.account_number }} - @{{ acc.account_name }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-2 col-xs-12">
                                <div class="box">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input v-model="bankBalance" type="number"
                                                class="form-control form-control-sm rounded-0" name="book_ref"
                                                id="book_ref" placeholder="0.00" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input v-model="filter.date_from" type="date"
                                                class="form-control form-control-sm rounded-0" name="date_from"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input v-model="filter.date_to" type="date"
                                                class="form-control form-control-sm rounded-0" name="date_to" id="dateTo"
                                                required>
                                        </div>
                                    </div>
                                </div>
                    ...
                    if (this.reconData.length) {
                        ...
                        this.reconData[0][0].entries.forEach(data => {
                            if (data.status.toLowerCase() == 'cleared') {
                                ...
                                this.reconData[0].totalWithdrawalsCleared += parseFloat(data
                                    .withdrawals);
                            } else {
                                this.reconData[0].totalDepositsUncleared += parseFloat(data.deposits);
                                this.reconData[0].totalWithdrawalsUncleared += parseFloat(data
                                    .withdrawals);
                            }
                        });
