<aside class="main-sidebar elevation-4 sidebar-light-olive">
    ...
    <a href="{{ route('dashboard') }}" class="brand-link elevation-4">
        <span class="brand-text font-weight-bold" style="font-size:1em; padding-left:2px;">Micro Access Loan
            Corporation</span>
    </a>
    ...
    <div class="sidebar" style="overflow-y: auto;">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                Welcome
                <a href="#" class="d-block"><b>{{ ucwords(Auth::user()->personal_info->fname) }}
                        {{ ucwords(Auth::user()->personal_info->lname) }}</b></a>
            </div>
        </div>
    ...
    with font-awesome or any other icon font library -->
                ...
                @if (checkUserHasAccessModule('module', 'journal'))
                    <li
                        class="nav-item {{ request()->is('journal') || request()->is('journal/journalEntry') || request()->is('journal/journalEntryList') ? 'menu-open' : '' }}">
                        <a
                            class="nav-link {{ request()->is('journal') || request()->is('journal/journalEntry') || request()->is('journal/journalEntryList') ? '' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'journal/journalEntry'))
                                <li class="nav-item">
                                    <a href="{{ route('journal.journalEntry') }}"
                                        class="nav-link {{ request()->is('journal/journalEntry') ? 'active' : '' }}">
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'journal/journalEntryList'))
                                <li class="nav-item">
                                    <a href="{{ route('journal.journalEntryList') }}"
                                        class="nav-link {{ request()->is('journal/journalEntryList') ? 'active' : '' }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                ...
                @if (checkUserHasAccessModule('module', 'Disbursement'))
                    <li
                        class="nav-item {{ request()->is('disbursement') ? 'menu-open' : '' }} {{ request()->is('supplier') ? 'menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->is('disbursement') ? 'active' : '' }} {{ request()->is('supplier') ? 'active' : '' }}">
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'employees'))
                                <li class="nav-item">
                                    <a href="{{ route('employees') }}"
                                        class="nav-link {{ isset($nav) && $nav[1] == 'list' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                ...
                @if (checkUserHasAccessModule('module', 'reports'))
                    <li
                        class="nav-item {{ isset($nav) && $nav[0] == 'reports' ? 'menu-open' : '' }} {{ request()->is('reports') ||
                        request()->is('reports/journalledger') ||
                        request()->is('reports/subsidiary-ledger') ||
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('reports.journalLedger') }}"
                                    class="nav-link {{ request()->is('reports/journalledger') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Journal Ledger</p>
                                </a>
                            </li>
                            @if (checkUserHasAccessModule('sub-module', 'reports/subsidiary-ledger'))
                                <form id="subsidiary-ledger" action="{{ route('reports.subsidiary-ledger') }}"
                                    method="POST" style="display: none;">
                                    <input type="hidden" name="type" value="subsidiary-ledger">
                                    @csrf
                                </form>
                                <li class="nav-item">
                                    <a onclick="event.preventDefault(); document.getElementById('subsidiary-ledger').submit();"
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'reports/journal_entry'))
                                <li class="nav-item">
                                    <a href="{{ route('reports.journal_entry') }}"
                                        class="nav-link {{ request()->is('reports/journal_entry') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Journal Entry</p>
                                    </a>
                                </li>
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'reports/generalLedger'))
                                <li class="nav-item">
                                    <a href="{{ route('reports.generalLedger') }}"
                                        class="nav-link {{ request()->is('reports/generalLedger') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>General Ledger</p>
                                    </a>
                                </li>
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'reports/balance-sheet'))
                                <li class="nav-item">
                                    <a href="{{ route('reports.balancesheet') }}"
                                        class="nav-link {{ request()->is('reports/balance-sheet') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Balance Sheet</p>
                                    </a>
                                </li>
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'reports/trialBalance'))
                                <li class="nav-item">
                                    <a href="{{ route('reports.trialBalance') }}"
                                        class="nav-link {{ request()->is('reports/trialBalance') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Trial Balance</p>
                                    </a>
                                </li>
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'reports/bankReconcillation'))
                                <li class="nav-item">
                                    <a href="{{ route('reports.bankReconcillation') }}"
                                        class="nav-link {{ request()->is('reports/bankReconcillation') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'reports/cashPosition'))
                                <li class="nav-item">
                                    <a href="{{ route('reports.cashPosition') }}"
                                        class="nav-link {{ request()->is('reports/cashPosition') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Cash Position</p>
                                    </a>
                                </li>
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'reports/cashTransactionBlotter'))
                                <li class="nav-item">
                                    <a href="{{ route('reports.cashTransactionBlotter') }}"
                                        class="nav-link {{ request()->is('reports/cashTransactionBlotter') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'reports/cheque'))
                                <li class="nav-item">
                                    <a href="{{ route('reports.cheque') }}"
                                        class="nav-link {{ request()->is('reports/cheque') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Cheque</p>
                                    </a>
                                </li>
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'reports/postDatedCheque'))
                                <li class="nav-item">
                                    <a href="{{ route('reports.postDatedCheque') }}"
                                        class="nav-link {{ request()->is('reports/postDatedCheque') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'reports/monthly-depreciation/report'))
                                <form id="monthly-depreciation-report"
                                    ...
                                    style="display: none;">
                                    <input type="hidden" name="type" value="monthly-depreciation-report">
                                    @csrf
                                </form>
                                <li class="nav-item">
                            ...
                            @if (checkUserHasAccessModule('sub-module', 'reports/chartOfAccounts'))
                                <li class="nav-item">
                                    <a href="{{ route('reports.chartOfAccounts') }}"
                                        class="nav-link {{ request()->is('reports/chartOfAccounts') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                ...
                @if (checkUserHasAccessModule('module', 'System Setup'))
                    <li class="nav-item">
                        <a href="{{ route('systemSetup') }}"
                            class="nav-link {{ request()->is('systemSetup') ? 'active' : '' }}">
