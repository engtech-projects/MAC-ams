            ...
            <div class="box">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form-control-sm rounded-0" name="sub_cat_code"
                            id="sub_cat_code" placeholder="Category Code" required>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4 col-xs-12">
            <div class="box">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form-control-sm rounded-0" name="sub_cat_name"
                            id="sub_cat_name" placeholder="Category Name" required>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-xs-12">
            <div class="box">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form-control-sm rounded-0" name="sub_cat_type"
                            id="sub_cat_type" placeholder="Category Type" required>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-xs-12">
            <div class="box">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <textarea type="text" class="form-control form-control-sm rounded-0" name="cat_description" id="cat_description"
        ...
        <div class="col-md-4 col-xs-12">
            <div class="box">
                <div class="form-group">
                    ...
                    <select name="account_id_credit" class="select2 form-control" id="select-account-credit"
                        value="" required>
                        <option>Acc 1</option>
                        <option>Acc 2</option>
                    </select>
        ...
        <div class="col-md-4 col-xs-12">
            <div class="box">
                <div class="form-group">
                    ...
                    <select name="account_id_debit" class="select2 form-control" id="select-account-debit"
                        value="" required>
                        <option>Acc 1</option>
                        <option>Acc 2</option>
                    </select>
