...
class JournalController extends MainController
{
    ...
    {
        $journalEntry = JournalEntry::with(['bookDetails',  'journalEntryDetails','journalEntryDetails.account','journalEntryDetails.subsidiary'])->where('journal_id', $request->journal_id)->get();
